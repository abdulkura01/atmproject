<?php 
    ...
    if(isset($_POST))
    {
       ...
       if($amnt > $prevAmount)
       {
            echo "Your withdrawa amount exceed your account balance! click <a href='javascript:;' history.go(-1)>here<a> to go back"; exit();
       }
       ...
       $rgdf= mysqli_query($conn,"INSERT INTO `ledger`(`userId`, `bf`, `amnt`, `cf`, `detail`, `date`) VALUES ('$uId','$prevAmount','$amnt','$newBal','DR','$date')");

       if(mysqli_affected_rows($conn) > 0)
       {
           $_SESSION['amnt']= $amnt;

           $_SESSION['detail']= "Withdraw";
